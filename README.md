...
| Variable Name | Value |
|---------------|-------|
| cron | <pre><code> - file: hello state: present tasks: - cmdline: echo 'hello' day: '*' hour: '6' minute: '05' month: '*' name: say_hello state: present user: www-data weekday: '*' </code></pre> |
